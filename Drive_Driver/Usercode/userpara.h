 ...
 */
#ifndef DRIVE1_MAX_CURRENT
#define DRIVE1_MAX_CURRENT 7.0f // 电流限制
#endif
#ifndef DRIVE2_MAX_CURRENT
#define DRIVE2_MAX_CURRENT 7.0f // 电流限制
#endif
 ...
 */
// 速度环 PID 相关定义
extern PID_t Drive1_speed_pi; // 驱动电机速度PI控制器结构体

// 电流环 PID 相关定义
extern PID_t Drive1_id_pi; // 驱动电机1 d轴电流PI控制器结构体
extern PID_t Drive1_iq_pi; // 驱动电机1 q轴电流PI控制器结构体

// SVPWM 输出相关定义
extern dq_t Drive1_udq;            // 驱动电机1 dq 轴指令电压
extern abc_t Drive1_uabc;          // 驱动电机1 ABC 相指令电压
extern duty_abc_t Drive1_duty_abc; // 驱动电机1 ABC 相占空比值

// 电流采样相关定义
extern curr_sample_t Drive1_curr; // 驱动电机1采样电流相关结构体

extern abc_t Drive1_iabc; // 驱动电机1 ABC 相电流(原始值)
extern dq_t Drive1_idq;   // 驱动电机1 dq 轴电流(原始值)

// 速度/位置采样相关定义
extern ad2s1210_t Drive1_AD2S; // 负载电机1的旋变解码板结构体

extern float drive1_speed_ref; // 速度指令值
...
// 电流采样相关定义
extern curr_sample_t Drive2_curr; // 驱动电机2采样电流相关结构体

extern abc_t Drive2_iabc; // 负载电机2 ABC 相电流(原始值)
extern dq_t Drive2_idq;   // 负载电机2 dq 轴电流(原始值)
