...
{
    Drive1_AD2S.Mechanical_Angle = 0;
    Drive1_AD2S.Electrical_Angle = 0;
    Drive1_AD2S.Electrical_Angle_offset = 2.133641;
    Drive1_AD2S.Angle = 0;
    Drive1_AD2S.fluat_data = 0;
    Drive1_AD2S.Register_data = 0;
    Drive1_AD2S.Speed = 0;
    Drive1_AD2S.Current_Speed = 0;

    Drive2_AD2S.Mechanical_Angle = 0;
    Drive2_AD2S.Electrical_Angle = 0;
    Drive2_AD2S.Electrical_Angle_offset = 2.121847;
    Drive2_AD2S.Angle = 0;
    Drive2_AD2S.fluat_data = 0;
    Drive2_AD2S.Register_data = 0;
    Drive2_AD2S.Speed = 0;
    Drive2_AD2S.Current_Speed = 0;
}
...
void AD2S1210_Angle_Get(void)
{
    ...
    /***电机1***/
    Drive1_AD2S.Mechanical_Angle = (res.position_data1 - 32767) * M_PI / 32767.f;
    Drive1_AD2S.Electrical_Angle = normalize(5, Drive1_AD2S.Mechanical_Angle, Drive1_AD2S.Electrical_Angle_offset);
    /***电机2***/
    Drive2_AD2S.Mechanical_Angle = (res.position_data2 - 32767) * M_PI / 32767.f;
    Drive2_AD2S.Electrical_Angle = normalize(5, Drive2_AD2S.Mechanical_Angle, Drive2_AD2S.Electrical_Angle_offset);
}

/**
 * @brief   AD2S1210 读取机械角速度(rpm)
 */
void AD2S1210_Speed_Get(void)
{
    ...
    /***电机1***/
    Drive1_AD2S.Speed_read = (int16_t)(res.velocity_data1);
    Drive1_AD2S.Current_Speed = (float)(Drive1_AD2S.Speed_read * 0.329f); // 125*60/2^15
    Drive1_AD2S.Speed = 0.01f * Drive1_AD2S.Current_Speed + 0.99f * Drive1_AD2S.Speed;

    /***电机2***/
    Drive2_AD2S.Speed_read = (int16_t)(res.velocity_data2);
    Drive2_AD2S.Current_Speed = -(float)(Drive2_AD2S.Speed_read * 0.329f); // 125*60/2^15
    Drive2_AD2S.Speed = 0.01f * Drive2_AD2S.Current_Speed + 0.99f * Drive2_AD2S.Speed;
}