...
#define STOP_PIN_Pin GPIO_PIN_2
#define STOP_PIN_GPIO_Port GPIOF
#define CUR_TEST_Pin GPIO_PIN_4
#define CUR_TEST_GPIO_Port GPIOF
#define SPD_TEST_Pin GPIO_PIN_5
#define SPD_TEST_GPIO_Port GPIOF
...
#define EN_GAN1_Pin GPIO_PIN_12
#define EN_GAN1_GPIO_Port GPIOF
...
#define PROT_EXTI_Pin GPIO_PIN_15
#define PROT_EXTI_GPIO_Port GPIOE
#define PROT_EXTI_EXTI_IRQn EXTI15_10_IRQn
