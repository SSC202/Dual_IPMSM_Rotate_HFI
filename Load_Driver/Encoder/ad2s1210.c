...
ad2s1210_t Load1_AD2S, Load2_AD2S;
...
{
    Load1_AD2S.Mechanical_Angle        = 0;
    Load1_AD2S.Electrical_Angle        = 0;
    Load1_AD2S.Electrical_Angle_offset = 0.56433;
    Load1_AD2S.Angle                   = 0;
    Load1_AD2S.fluat_data              = 0;
    Load1_AD2S.Register_data           = 0;
    Load1_AD2S.Speed                   = 0;
    Load1_AD2S.Current_Speed           = 0;

    Load2_AD2S.Mechanical_Angle        = 0;
    Load2_AD2S.Electrical_Angle        = 0;
    Load2_AD2S.Electrical_Angle_offset = 0.52003;
    Load2_AD2S.Angle                   = 0;
    Load2_AD2S.fluat_data              = 0;
    Load2_AD2S.Register_data           = 0;
    Load2_AD2S.Speed                   = 0;
    Load2_AD2S.Current_Speed           = 0;
}
...
void AD2S1210_Angle_Get(void)
{
    ...
    /***电机1***/
    Load1_AD2S.Mechanical_Angle = (res.position_data1 - 32767) * M_PI / 32767.f;
    Load1_AD2S.Electrical_Angle = normalize(4, Load1_AD2S.Mechanical_Angle, Load1_AD2S.Electrical_Angle_offset);
    /***电机2***/
    Load2_AD2S.Mechanical_Angle = (res.position_data2 - 32767) * M_PI / 32767.f;
    Load2_AD2S.Electrical_Angle = normalize(4, Load2_AD2S.Mechanical_Angle, Load2_AD2S.Electrical_Angle_offset);
}
...
void AD2S1210_Speed_Get(void)
{
    ...
    /***电机1***/
    Load1_AD2S.Speed_read    = (int16_t)(res.velocity_data1);
    Load1_AD2S.Current_Speed = (float)(Load1_AD2S.Speed_read * 0.329f); // 125*60/2^15
    Load1_AD2S.Speed         = 0.01f * Load1_AD2S.Current_Speed + 0.99f * Load1_AD2S.Speed;

    /***电机2***/
    Load2_AD2S.Speed_read    = (int16_t)(res.velocity_data2);
    Load2_AD2S.Current_Speed = -(float)(Load2_AD2S.Speed_read * 0.329f); // 125*60/2^15
    Load2_AD2S.Speed         = 0.01f * Load2_AD2S.Current_Speed + 0.99f * Load2_AD2S.Speed;
}